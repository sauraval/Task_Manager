...
function Todoitems({ id, name, description, complete }) {
        ...
        <li className=' w-full p-4 border-2 border-zinc-700 border-b-zinc-900'>
            <div className='flex flex-col justify-between items-center md:flex-row'>
                ...
                <div className='flex flex-row gap-4 m-4'>
                    ...
                    <button onClick={()=> handleDelete(id)} className='rounded-full bg-white font-semibold p-1 px-3 border-2 border-red-600 ms-3 text-red-600 '>
                        Delete
                    </button>
                </div>
            </div>
